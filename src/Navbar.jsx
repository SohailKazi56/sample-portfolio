            ...
            <div className = "container-fluid nav_bg">
                <div className = "row">
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light ">
                        <NavLink className="navbar-brand" style={{fontSize:'1.5rem',fontWeight:'600',color:'blueviolet'}} to="/">TechFish</NavLink>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li className="nav-item " >
                                <NavLink activeClassName='menu-active' className="nav-link active" aria-current="page" to="/">Home <span className="sr-only">(current)</span></NavLink>
                            </li>
                            <li className="nav-item">
